...
(function($){
  ...
  MyYoutube.prototype.bindingEvent = function(){
    ...
    $("body").on("mouseenter", "article .pic", function(e){
      e.preventDefault();
      var target = e.currentTarget;
      this.hover(target);
    }.bind(this));
    
    $("body").on("mouseleave", "article .pic", function(e){
      e.preventDefault();
      var target = e.currentTarget;
      this.leave(target);
    }.bind(this));
  ...
  MyYoutube.prototype.hover = function(target){
    ...
    $(target).next("h2").css({top:"50%", opacity: 1});
    $(target).next().next("p").css({right: 20, opacity: 1});
  ...
  MyYoutube.prototype.leave = function(target){
    ...
    $(target).next("h2").css({top: "40%", opacity: 0});
    $(target).next().next("p").css({right: -100, opacity: 0});
  }
})(jQuery);
